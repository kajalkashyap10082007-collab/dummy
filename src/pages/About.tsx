...
export function About() {
 ...
 {[
 { name: 'Elena Rostova', role: 'Founder & CEO', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&fm=webp&w=800' },
 { name: 'Marcus Jin', role: 'Head of Design', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&fm=webp&w=800' },
 { name: 'Sarah O\'Connor', role: 'Sustainability Director', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&fm=webp&w=800' }
 ].map((member, i) => (
 <motion.div 
 key={member.name}
